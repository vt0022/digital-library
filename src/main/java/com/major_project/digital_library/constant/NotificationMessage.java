...
public enum NotificationMessage {
    ...
    REPLY("đã phản hồi về bài đăng của bạn"),
    LIKE_REPLY("đã thích phản hồi của bạn"),
    ...
    WARN_REPLY("Phản hồi của bạn đã bị gỡ do vi phạm tiêu chuẩn cộng đồng về"),
    DELETE_POST("Bài đăng của bạn đã bị xoá vì vi phạm tiêu chuẩn cộng đồng về"),
    DELETE_REPLY("Phản hồi của bạn đã bị xoá vì vi phạm tiêu chuẩn cộng đồng về"),
    RESTORE_POST("Bài đăng của bạn đã được khôi phục. Rất xin lỗi vì sự nhầm lẫn"),
    RESTORE_REPLY("Phản hồi của bạn đã được khôi phục. Rất xin lỗi vì sự nhầm lẫn"),
